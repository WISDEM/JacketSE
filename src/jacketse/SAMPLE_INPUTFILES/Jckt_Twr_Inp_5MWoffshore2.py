...
JckTwr.Db=5.46 #         [m]   base outer diameter (Python)
JckTwr.Dt=3.86;        # [m] top outer diameter

#!!!!!!!!!!!!!!!!!!!!!!!!!!TOWER HEIGHT LOOK BELOW!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

#JckTwr.DTR=120;                  # D to thickness ratio
JckTwr.DTRb=JckTwr.Db/0.025;      # D to thickness ratio 6t base
JckTwr.DTRt=JckTwr.Dt/0.019;      # D to thickness ratio at top
JckTwr.Htwr2=0.; # [m] height of untapered section of tower
...
JckTwr.stthgt=6.769*tan(JckTwr.al_stt*pi/180.);# height above base of TP to where strutts terminate [m] =l.stt.h * tan(90-beta.stt) in mathcad
